...
- 가운데 세트 칸 글자는 칸 크기에 맞춤. 세트 점수는 칸 안에서 직전보다 크게. 시각·서브·새 경기는 세트 점수 아래 세로 가운데. 현재 시각·경기 시간(선서브부터). 새 경기 글자는 버튼에 맞춤.
- 경기는 3세트 2선승만 (`bo3_2`).
...
- 가운데 세트 칸: 「세트」·서브 안내·시각·경기 시간은 칸 비율, 세트 점수는 칸 안에서 키움, 시각·서브·새 경기는 세트 점수 아래 세로 가운데. 경기 시간은 선서브부터, 새 경기에서 0.
