...
**제품:** Jokguboard  
**정리일:** 2026-09-09  
**현재 설치:** `app-debug-0909_2357-nameserve.apk`  
**다운로드:** https://jokguboard.vercel.app/downloads/app-debug-0909_2357-nameserve.apk  
...
| `app-debug-0909_2357-nameserve.apk` | 23:57 | 팀명 세트쪽·터치수정·새경기 선서브 | |

## 현재 버전에서 쓰는 것

`app-debug-0909_2357-nameserve.apk`가 위 표를 모두 이은 최신이다.
