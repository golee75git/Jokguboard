...
**제품:** Jokguboard  
**정리일:** 2026-09-09  
**현재 설치:** `app-debug-0909_2256-winflow.apk`  
**다운로드:** https://jokguboard.vercel.app/downloads/app-debug-0909_2256-winflow.apk  
...
| `app-debug-0909_2256-winflow.apk` | 22:56 | 세트 5초 자동 닫힘·경기 승 새 경기 | |

## 현재 버전에서 쓰는 것

`app-debug-0909_2256-winflow.apk`가 위 표를 모두 이은 최신이다.

- 족구 랠리 득점, 사이드아웃 시 직전 서브 팀만 1→2→3→4
- Futnet 11점 캡 15, 득점자 서브
- 원 점수 위·아래 2×2(화면 왼쪽 3·4/2·1, 오른쪽 1·2/4·3), 숫자 고정, 선서브 금색은 1번, 서브 원 더 큼
- 새 경기 보드 확인, 사이버·링에서도 클릭. 세트 안내 창은 5초 후 자동 닫힘. 경기 승 창은 확인+새 경기
- 심플, TTS, BLE, 스킨, 하단 메뉴
