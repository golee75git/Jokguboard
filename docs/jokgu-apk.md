...
**제품:** Jokguboard  
**정리일:** 2026-09-09  
**현재 설치:** `app-debug-0910_1512-barlight.apk`  
**다운로드:** https://jokguboard.vercel.app/downloads/app-debug-0910_1512-barlight.apk  
...
| `app-debug-0910_1512-barlight.apk` | 15:12 | 밝은 백 칸 검은 서브 바 | *(커밋 후 기록)* |

## 현재 버전에서 쓰는 것

`app-debug-0910_1512-barlight.apk`가 위 표를 모두 이은 최신이다.
