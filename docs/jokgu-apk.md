...
**제품:** Jokguboard  
**정리일:** 2026-09-12  
**현재 설치:** `app-debug-0912_1620-baruphide.apk`  
**다운로드:** https://jokguboard.vercel.app/downloads/app-debug-0912_1620-baruphide.apk  
...
`app-debug-0912_1620-baruphide.apk`가 위 표를 모두 이은 최신이다.
...
- 패드 Kotlin은 위 버튼 판정 뒤에만 시스템 바를 닫음. 손가락으로 연 바는 그대로(`JK_HID_BAR_GUARD`)
