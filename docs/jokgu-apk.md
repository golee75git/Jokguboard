...
**제품:** Jokguboard  
**정리일:** 2026-09-09  
**현재 설치:** `app-debug-0910_1145-setmid.apk`  
**다운로드:** https://jokguboard.vercel.app/downloads/app-debug-0910_1145-setmid.apk  
...
| `app-debug-0910_1145-setmid.apk` | 11:45 | 세트 점수 키움·세로 가운데 모임 | *(커밋 후 기록)* |

## 현재 버전에서 쓰는 것

`app-debug-0910_1145-setmid.apk`가 위 표를 모두 이은 최신이다.
...
- 가운데 칸 글자는 칸 크기에 맞춤(`JK_MID_FIT`). 세트 점수는 칸 안에서 직전보다 크게. 시각·서브·새 경기는 세트 점수 아래 세로 가운데. 가운데 칸 폭은 그대로. 현재 시각·경기 시간(선서브부터, 새 경기에서 0). 새 경기 글자는 버튼에 맞춤
