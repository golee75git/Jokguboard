...
**제품:** Jokguboard  
**정리일:** 2026-09-09  
**현재 설치:** `app-debug-0910_1118-midfit.apk`  
**다운로드:** https://jokguboard.vercel.app/downloads/app-debug-0910_1118-midfit.apk  
...
| `app-debug-0910_1118-midfit.apk` | 11:18 | 세트 칸 비율 글자·시각·경기시간 | *(커밋 후 기록)* |

## 현재 버전에서 쓰는 것

`app-debug-0910_1118-midfit.apk`가 위 표를 모두 이은 최신이다.
...
- 가운데 칸 글자는 칸 크기에 맞춤(`JK_MID_FIT`). 세트 점수는 남은 칸을 채움. 현재 시각·경기 시간(선서브부터, 새 경기에서 0). 새 경기 글자는 버튼에 맞춤
