...
**제품:** Jokguboard  
**정리일:** 2026-09-09  
**현재 설치:** `app-debug-0909_2331-padwin.apk`  
**다운로드:** https://jokguboard.vercel.app/downloads/app-debug-0909_2331-padwin.apk  
...
| `app-debug-0909_2331-padwin.apk` | 23:31 | 패드 고정+세트 안내 중에도 득점 | |

## 현재 버전에서 쓰는 것

`app-debug-0909_2331-padwin.apk`가 위 표를 모두 이은 최신이다.
